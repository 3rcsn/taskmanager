...
class TaskControllerTest {
    ...
    @Test
    void shouldSaveAndRetrieveTaskById() throws Exception {
        ...
        String responseJson = this.mockMvc.perform(
            ...
            .andDo(document("create-task",
                    ...
                    responseFields(
                            ...
                            fieldWithPath("title").description("Titulo da tarefa"),
                            fieldWithPath("description").description("Descrição detalhada"),
                            fieldWithPath("status").description("Status de tarefa")
                    )
            ))
            .andReturn()
            .getResponse()
        ...
        .andDo(document("get-task-by-id",
            ...
            responseFields(
                    fieldWithPath("id").description("Identificador único da task"),
                    fieldWithPath("title").description("Titulo da tarefa"),
                    fieldWithPath("description").description("Descrição detalhada"),
